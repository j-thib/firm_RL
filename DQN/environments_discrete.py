...
"""class socialPlannerEnv:
    def __init__(self, tax, price_reg, gamma=1, eta=1):
        # Tax actions we can take: {10%, 25%, 40%}
        # Allow firms to fluctuate prices by: {5%, 10%, 50%, 100%}
    ...
    def step(self, actions, firm_rewards, quantities):
        tax_action, price_reg_action = actions
        ...
        if price_reg_action == 0:
            price_reg_action = 0.05
        elif price_reg_action == 1:
            price_reg_action = 0.1
        elif price_reg_action == 2:
            price_reg_action = 0.5
        else:
            price_reg_action = 1.0
